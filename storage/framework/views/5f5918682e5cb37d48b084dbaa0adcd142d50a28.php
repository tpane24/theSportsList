...
<div class="contentContainer container">
  <div class="h3 text-center light-blue-text text-center banner-title">theSportsList | View Advertisement</div>
  <?php
  ...
  ?>
  <div id="buttonDiv" class="h5 text-center mt-4 pt-4 mb-4 pb-4"><a href="<?php echo e(route('advertising.home')); ?>"><button class="blue-button">Go Back</button></a></div>
